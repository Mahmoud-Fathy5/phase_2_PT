...
public:
	...
	void DrawCondtional(Point Left, int width, int height, string Text, bool Selected = false);
	void DrawRead(Point Left, int width, int height, string Var, bool Selected = false);
	void DrawWrite(Point Left, int width, int height, string Var, bool Selected = false);

	//TODO: Add DrawConnector function

	void DrawConnector(Point first, Point Second, bool Selected = false);
